...
.. literalinclude:: ../../../examples/scenarios/bank.py
   :language: python

``sim.cfg`` stored under the ``log`` folder contains:

.. literalinclude:: ../../../examples/scenarios/log/bank/run01/sim.cfg

``sim.log`` stored under the ``log`` folder contains:

.. literalinclude:: ../../../examples/scenarios/log/bank/run01/sim.log
